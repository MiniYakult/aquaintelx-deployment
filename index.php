    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="brand">
                ...
                <button class="close-sidebar-btn" id="close-sidebar-btn"><i class="ph ph-x"></i></button>
            </div>
            <nav class="nav-menu">
            ...
            <div id="contact" class="page-section">
                <div class="contact-container">
                    <div class="panel contact-info">
                        <h3>Get in Touch</h3>
                        <p>Need support or want to expand your AquaIntelX sensor network? Reach out to our engineering team.</p>
                        <div class="info-list">
                            <div class="info-item">
    ...
    <div class="modal-overlay" id="connection-modal">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button class="close-modal-btn" id="close-conn-modal"><i class="ph ph-x"></i></button>
            </div>
            <div class="modal-body">
                <p class="modal-desc">Select how to connect to your AquaIntelX sensor array.</p>
                
                <div class="conn-options">
                    <div class="conn-card" id="conn-wifi" tabindex="0">
                        <div class="conn-icon"><i class="ph ph-wifi-high"></i></div>
                        <div class="conn-info">
                            <h3>WiFi Network</h3>
                    ...
                    <div class="conn-card" id="conn-wired" tabindex="0">
                        <div class="conn-icon"><i class="ph ph-usb"></i></div>
                        <div class="conn-info">
                            <h3>Wired (USB)</h3>
                ...
                <div class="conn-details" id="wifi-config">
                    ...
                    <button class="btn btn-primary" id="btn-connect-wifi" style="width: 100%;">Connect to Network</button>
                </div>
            </div>
        </div>
    </div>
